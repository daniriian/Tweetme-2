...
@api_view(['POST'])  # decoator, client can only send POST
...
@api_view(['GET'])  # decorator, client can only send GET
...
@api_view(['GET'])  # decoator, client can only send GET
...
@api_view(['DELETE', 'POST'])  # decoator, client can only send GET
@permission_classes([IsAuthenticated])
...
@api_view(['POST'])  # decoator, client can only send GET
@permission_classes([IsAuthenticated])
